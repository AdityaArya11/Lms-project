    ...
    <footer className='bg-gray-900 md:px-36 text-left w-full mt-10'>
      ...
      border-white/30'>
        ...
        <div className='hidden md:flex flex-col items-start w-full'>
          ...
          <p className='py-4 text-center text-xs md:text-sm text-white/80'>The latest news, articles, and
      ...
      <p className='py-4 text-center text-xs md:text-sm text-white/60'>Copyright 2026 © ElevateEd. All rights reserved.</p>
    </footer>
  )
}
