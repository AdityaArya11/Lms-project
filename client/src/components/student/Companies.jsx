...
const Companies = () => {
    return (
        <div className='pt-16'>
            <p className='text-center text-gray-500 mb-4 font-medium text-lg'>Trusted By learners from</p>
            <div className='flex items-center justify-centre gap-6 md:gap-16 md:mt-10 mt-5'> 
